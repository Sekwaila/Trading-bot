...
Location: signals/signal_engine.py
"""
...
class BrokerDataEngine:
    """
    Connects to Broker APIs / MetaApi / Real-Time Ticks
...
def generate_omega_signal(
    ...
    try:
        ...
        # Determine live price reference
        ...
        # Bias and TF alignment evaluation
        bull_count = 0
        bear_count = 3  # Active setup alignment
        ...
        # Targets calculated strictly off live broker entry price
        if overall_bias == "BUY":
            entry = current_price
