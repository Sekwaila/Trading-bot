...
class SignalEngine:
    ...
    def generate_signal(self, df):
        ...
        # Floor ATR so a quiet/flat print can't collapse SL/TP onto entry
        atr_raw = last["atr"]
        ...
        # Liquidity Sweeps
        # =====================================
        # NOTE: Liquidity.analyze() returns "buy_liquidity" / "sell_liquidity",
        # not "bullish_sweep" / "bearish_sweep". The original keys here were a
        # mismatch — .get() failed silently (returned None) and this block
        # never contributed to either score. Fixed to use the real keys.
