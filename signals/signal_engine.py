...
class SignalEngine:
    ...
    # =====================================
    # Configurable constants (tune after backtesting)
    # =====================================
    PRACTICAL_MAX_SCORE = 280   # Adjust based on observed score distribution
    MIN_CONFIDENCE = 60         # Minimum confidence to generate a signal
    ...
    def generate_signal(self, df):
        ...
        # =====================================
        # Confidence Calculation (using class constants)
        # =====================================

        max_score = max(buy_score, sell_score)

        confidence = round((max_score / self.PRACTICAL_MAX_SCORE) * 100)
