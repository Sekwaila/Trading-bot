...
# -----------------------------------------------------------------------------
# 1. PAGE CONFIGURATION & TRADING TERMINAL CSS
# -----------------------------------------------------------------------------
st.set_page_config(
...
def classify_signal(res):
    ...
    """
    if not res.get("ok"):
        return "DATA UNAVAILABLE", "glow-neutral", 0
    ...
    if bias == "BUY":
        if score >= 85 and tf_count >= 4:
            return "EXTREME BUY", "glow-extreme-buy", score + 100
        elif score >= 75 or tf_count >= 3:
            return "STRONG BUY", "glow-strong-buy", score + 75
        elif score >= 60:
            return "BUY", "glow-buy", score + 50
        else:
            return "WEAK BUY", "glow-weak-buy", score + 25

    elif bias == "SELL":
        if score >= 85 and tf_count >= 4:
            return "EXTREME SELL", "glow-extreme-sell", score + 100
        elif score >= 75 or tf_count >= 3:
            return "STRONG SELL", "glow-strong-sell", score + 75
        elif score >= 60:
            return "SELL", "glow-sell", score + 50
        else:
            return "WEAK SELL", "glow-weak-sell", score + 25
...
# -----------------------------------------------------------------------------
# 3. SESSION STATE & NAVIGATION INITIALIZATION
# -----------------------------------------------------------------------------
...
# =============================================================================
# ROUTE A: MAIN LIVE DASHBOARD (SORTED GLOWING SIGNAL CARDS)
# =============================================================================
            ...
            with st.container():
                ...
                <div class="signal-card">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
                        <span style="font-size:1.3rem; font-weight:800; color:#f8fafc;">{sym}</span>
...
# =============================================================================
# ROUTE B: DEDICATED PAIR WORKSPACE (CLICKED A PAIR)
# =============================================================================
    ...
    # --- TOP ROW: EXECUTION & POSITION SIZING ---
    m1, m2, m3, m4, m5, m6 = st.columns(6)
    with m1: st.markdown(f'<div class="metric-box"><div class="metric-label">Entry</div><div class="metric-val">{price(res.get("entry"))}</div></div>', unsafe_allow_html=True)
