...
st.markdown("""
<style>
    .stApp { background-color: #0A0D14 !important; color: #E2E8F0; }
    ...
    .signal-header { font-size: 28px; font-weight: 800; color: #FFFFFF; margin: 0; }
    .signal-price { font-size: 24px; font-weight: 700; color: #10B981; }
    .badge-buy-glow {
    ...
    .score-value { font-size: 24px; font-weight: 800; color: #FFFFFF; }
...
with st.sidebar:
    ...
    st.markdown("---")
    st.radio("Navigation", ["🏠 Dashboard", "📊 Market Scanner", "🔥 Heatmap", "🧠 AI Narrator", "⚙️ Settings"], label_visibility="collapsed")
    st.markdown("---")
...
<div style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 10px;">
    <div>
        ...
        <p style="margin:0; color: #94A3B8; font-size: 12px;">ANCIENT WISDOM. MODERN PROFIT.</p>
    </div>
...
with m1:
    st.markdown('<div class="card-box" style="padding:12px; text-align:center;"><div class="text-muted">🟢 BUY SETUPS</div><div style="font-size:26px; font-weight:800; color:#10B981;">2</div><div style="font-size:10px; color:#10B981;">↑ SP500, US30</div></div>', unsafe_allow_html=True)
with m2:
    st.markdown('<div class="card-box" style="padding:12px; text-align:center;"><div class="text-muted">🔴 SELL SETUPS</div><div style="font-size:26px; font-weight:800; color:#EF4444;">2</div><div style="font-size:10px; color:#EF4444;">↑ XAUUSD, EURUSD</div></div>', unsafe_allow_html=True)
with m3:
    st.markdown('<div class="card-box" style="padding:12px; text-align:center;"><div class="text-muted">🔥 ACTIVE NOW</div><div style="font-size:26px; font-weight:800; color:#10B981;">2</div><div style="font-size:10px; color:#10B981;">↑ SP500, US30</div></div>', unsafe_allow_html=True)
with m4:
    st.markdown('<div class="card-box" style="padding:12px; text-align:center;"><div class="text-muted">📡 SESSION</div><div style="font-size:18px; font-weight:800; color:#F59E0B; margin-top:4px;">LONDON</div><div style="font-size:10px; color:#10B981;">● Active Killzone</div></div>', unsafe_allow_html=True)
with m5:
    st.markdown('<div class="card-box" style="padding:12px; text-align:center;"><div class="text-muted">💵 DXY</div><div style="font-size:26px; font-weight:800; color:#10B981;">99.73</div><div style="font-size:10px; color:#10B981;">▲ BULL</div></div>', unsafe_allow_html=True)
...
<div class="card-box">
    ...
    <div style="display:flex; gap:15px; margin-top:20px; align-items:center;"> 
        <div class="badge-buy-glow" style="flex:1;"> 🚀 STRONG BUY </div> 
...
with c2:
    st.markdown(timeframe_table_html, unsafe_allow_html=True)
