...
# -------------------------------------------------------------------
# CUSTOM ULTRA-DARK NEON STYLING (Matches Rocket.new Screenshots)
# -------------------------------------------------------------------
st.markdown("""
<style>
    /* Dark background */
    ...
    .text-muted { color: #94A3B8; font-size: 11px; text-transform: uppercase; }
</style>
...
with st.sidebar:
    ...
    account_bal = st.number_input("Account Balance (R)", value=500.0, step=50.0)
    risk_pct = st.slider("Risk %", 0.25, 5.0, 1.0, 0.25)
    st.caption(f"Risk Amount: **R{(account_bal * risk_pct) / 100:.2f}**")
...
with m1:
    ...
    <div class="card-box" style="padding:12px; text-align:center;">
        ...
        <div style="font-size:28px; font-weight:800; color:#10B981;">2</div>
...
with m2:
    ...
    <div class="card-box" style="padding:12px; text-align:center;">
        ...
        <div style="font-size:28px; font-weight:800; color:#EF4444;">2</div>
...
with m4:
    ...
    <div class="card-box" style="padding:12px; text-align:center;">
        ...
        <div style="font-size:20px; font-weight:800; color:#F59E0B; margin-top:4px;">LONDON</div>
...
with m5:
    ...
    <div class="card-box" style="padding:12px; text-align:center;">
        ...
        <div style="font-size:28px; font-weight:800; color:#10B981;">99.73</div>
        <div style="font-size:10px; color:#10B981;">▲ BULL</div>
    </div>
    """, unsafe_allow_html=True)

# -------------------------------------------------------------------
# MAIN SIGNAL DISPLAY (Matching Screenshot 4/5 Signal Card)
# -------------------------------------------------------------------
...
with c1:
    ...
    <div class="card-box">
        ...
        <div style="display:flex; gap:15px; margin-top:20px; align-items:center;">
            ...
            <div style="background:#161D2A; padding:10px 16px; border-radius:10px; border:1px solid #232D42;">
