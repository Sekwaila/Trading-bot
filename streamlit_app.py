...
<style>
    ...
    .tp-text { color: #00e676; font-size: 13px; font-weight: bold; }
    .sl-text { color: #ff3d00; font-size: 13px; font-weight: bold; }
...
with col_center:
    ...
    <div class="signal-main">
        ...
        <div style="margin-top:12px; font-size:12px; color:#d1d4dc;">
