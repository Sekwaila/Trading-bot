...
import requests
from signals.signal_engine import generate_omega_signal, format_telegram_message, fetch_usdzar_rate
...
with col_override:
    # Direct broker price input to eliminate MT4 mismatch
...
# Get current ZAR rate for reference
...
# Target Levels (For active setups)
if title != "NEUTRAL":
...
# Technicals & SMC Analysis Breakdown
