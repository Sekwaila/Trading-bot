...
# Background image URL (Replace with your uploaded image URL if hosted)
...
<style>
    /* Full App Background */
    .stApp {{
        background: linear-gradient(rgba(8, 9, 11, 0.88), rgba(8, 9, 11, 0.92)), url('{BACKGROUND_IMAGE_URL}') no-repeat center center fixed;
    ...
    .tp-text {{ color: #00e676; font-size: 15px; font-weight: bold; }}
    .sl-text {{ color: #ff3d00; font-size: 15px; font-weight: bold; }}
...
# ==========================================
# 2. MARKET DATA GENERATOR (MATCHING MT5 QUOTES)
# ==========================================
@st.cache_data(ttl=3)
...
with col_left:
    ...
    <div class="gold-card">
        ...
        <div style="color:#00e676; font-weight:bold; font-size:12px;">LONDON / NY OVERLAP</div>
        <div style="color:#787b86; font-size:10px;">HIGH VOLUME (Quality: 95%)</div>
    </div>
    
    <div class="gold-card">
        <div class="card-head">👤 ACCOUNT OVERVIEW</div>
        <div style="display:flex; justify-space-between; font-size:11px;"><span>Balance:</span><b>$10,256.80</b></div>
        <div style="display:flex; justify-space-between; font-size:11px;"><span>Equity:</span><b>$10,256.80</b></div>
        <div style="display:flex; justify-space-between; font-size:11px;"><span>Risk %:</span><b style="color:#00e676;">2.00%</b></div>
    </div>

    <div class="gold-card">
        <div class="card-head">📜 ANCIENT PROVERB</div>
        <div style="font-style:italic; font-size:11px; color:#dfb15b; line-height:1.3;">
            "We are not dead, we are just in another room."
        </div>
        <div style="font-size:9px; color:#787b86; margin-top:4px;">- African Proverb</div>
    </div>
    """, unsafe_allow_html=True)

# --- CENTER COLUMN (KATLEGO AI SIGNAL PANEL - NO CHARTS) ---
with col_center:
    st.markdown(f"""
    <div class="signal-main">
        <div style="display:flex; justify-content:space-between; align-items:center;">
            <span style="font-size:20px; font-weight:bold; color:#fff;">{pair}</span>
        ...
        <div style="margin-top:15px; font-size:14px; color:#d1d4dc;">
            ENTRY PRICE: <b>{bid}</b> | CURRENT PRICE: <b>{bid}</b>
        </div>

        <div class="target-grid">
            <div class="target-box"><div style="font-size:9px; color:#787b86;">TP1</div><div class="tp-text">{tp1}</div><div style="font-size:8px; color:#787b86;">+63.5 PIPS</div></div>
            <div class="target-box"><div style="font-size:9px; color:#787b86;">TP2</div><div class="tp-text">{tp2}</div><div style="font-size:8px; color:#787b86;">+151.5 PIPS</div></div>
            <div class="target-box"><div style="font-size:9px; color:#787b86;">TP3</div><div class="tp-text">{tp3}</div><div style="font-size:8px; color:#787b86;">+298.0 PIPS</div></div>
            <div class="target-box"><div style="font-size:9px; color:#787b86;">STOP LOSS</div><div class="sl-text">{sl}</div><div style="font-size:8px; color:#787b86;">-122.5 PIPS</div></div>
        </div>
