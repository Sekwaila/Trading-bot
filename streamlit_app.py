...
# Yahoo Finance uses different tickers entirely — gold has no clean spot
# ticker on Yahoo, "XAUUSD=X" is the closest widely-available equivalent.
# If data quality looks off for gold specifically, "GC=F" (COMEX futures)
# is the more liquid/reliable alternative — swap it in here if needed.
YFINANCE_MAP = {
    "XAU/USD": "XAUUSD=X",
    "BTC/USD": "BTC-USD",
    "EUR/USD": "EURUSD=X",
